starter_news = [
  ...
  "Your cookie business has expanded big-time."]
...
pro_news = ["The whole planet is enjoying your cookies!",
  ...
  "A local news station runs a 10-minute segment about your cookies. Success!", #  this one is ... quite bad if aliens are coming just to taste cookies 
  '"We rise." - Grandma',
  '"Come give grandma a kiss." - Grandma']

legendary_news = ["Cookie farms suspected of employing undeclared elderly workforce!",
  ...
  "[between 2 and 1001, inclusive] miners dead in chocolate mine catastrophe!",
  "[between 2 and 1001, inclusive] miners trapped in collapsed chocolate mine!",
  "Chocolate mines found to cause earthquakes and sink holes!",
  "Chocolate mine goes awry, floods village in chocolate!",
  "Is our planet getting lighter? Experts examine the results of intensive chocolate mining."]

mythical_news = ["Cookie factories linked to global warming!",
  ...
  "Cookie economy now strong enough to allow for massive vaults doubling as swimming pools!",]
